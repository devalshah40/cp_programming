...
function deleteNode(root, l, h) {
  if (root === null) {
    return null;
  }

  if (root.data > h) {
    return deleteNode(root.left, l, h);
  }
  if (root.data < l) {
    return deleteNode(root.right, l, h);
  }

  root.left = deleteNode(root.left, l, h);
  root.right = deleteNode(root.right, l, h);
  return root;
}

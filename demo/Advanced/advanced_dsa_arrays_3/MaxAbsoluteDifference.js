...
function maxAbsoluteDiff(A) {
  ...
  let plusMax = Number.NEGATIVE_INFINITY,
    plusMin = Number.POSITIVE_INFINITY;
  let minusMax = Number.NEGATIVE_INFINITY,
    minusMin = Number.POSITIVE_INFINITY;
  for (let i = 0; i < N; i++) {
